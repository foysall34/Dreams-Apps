...
from .views import UserProfileTypeView,RegisterView, VerifyOTPAPI, LoginAPI , PasswordResetConfirmAPI, PasswordResetRequestAPI ,ResendOTPView,ResendOTPViewforPassword
